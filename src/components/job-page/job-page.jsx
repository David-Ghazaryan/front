...
const JobPage = ({jobTitle,companyTitle,logo,backgroundImage,phoneNumber,minWorkes,maxWorkes,description,jobDescription,city,industry}) => {
  ...
  return (
    <div className='containerPage'>
        <div className='flex flex-col shadow-lg'>
            <div className='w-full h-[350px] shadow-lg z-10 bg-[var(--itemColor)] '>
        ...
        <div className='flex gap-5 my-5'>
            <div className='flex flex-col w-2/3 gap-5'>
                <div className='bg-[var(--itemColor)] rounded-2 shadow-lg p-5 '>
                    <p className='font-bold text-2xl'>Նկարագրություն</p>
