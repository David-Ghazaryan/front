...
const Job = ({companyName,city,title,deadline,salary}) => {
   ...
   return (
    <div className="w-full min-h-[100px] bg-[var(--itemColor)]  hover:shadow-[inset_0_0_0_2px_var(--primary)] transition duration-300 rounded-[5px] shadow-lg mt-5">
        <div className='flex p-3'>
            <div className='w-[80px] h-[80px] mr-2'>
                <img src={digitainLogo} alt={companyName} />
            </div>
            <div className='flex flex-col '>
                <p className='font-bold ml-1 gap-1'>{title}</p>
                <p className='font-medium text-gray-400 ml-1'>{companyName}</p>
                <div className='flex gap-3 pt-1'>
                    ...
                    <div className='flex gap-1'>
                        ...
                        <p className='font-normal text-gray-400'>{salary}</p>
                    </div>:""}
                </div>
            </div>
        </div>
