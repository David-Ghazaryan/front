  ...
  return (
    <div className="container ">
        <div className=" flex flex-col items-center">
            <p className="font-bold font-inter text-[32px] text-[var(--primary)] ">Լավագույն աշխատակիցները մեկ հարթակում</p>
            <p className="font-extralight font-inter text-[14px] text-gray-500 2 pb-[15px] text-center">Ծանոթացիր փորձառու մասնագետներին և գտիր քո թիմի նոր անդամին։</p>
