...
const ReviewCard = ({image,name,surname,date,review}) => {
    return (
      <div className="cursor-pointer bg-[var(--itemColor)] shadow-lg rounded-2xl p-6 w-[300px] h-[280px]  border border-transparent hover:border-[var(--primary)] transition duration-150">
